...
class MobileCvCreatePage extends StatefulWidget {
  const MobileCvCreatePage({super.key});

  @override
  State<MobileCvCreatePage> createState() => _MobileCvCreatePageState();
}

class _MobileCvCreatePageState extends State<MobileCvCreatePage> {
  late FormGroup form;
  @override
  void initState() {
    form = FormGroup({
