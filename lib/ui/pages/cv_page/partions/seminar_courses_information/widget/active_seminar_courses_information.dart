...
class ActiveSeminarCoursesInformationWidget extends StatefulWidget {
  const ActiveSeminarCoursesInformationWidget({super.key});

  @override
  State<ActiveSeminarCoursesInformationWidget> createState() =>
      _ActiveSeminarCoursesInformationWidgetState();
}
...
class _ActiveSeminarCoursesInformationWidgetState
    extends State<ActiveSeminarCoursesInformationWidget> {
  late FormGroup form;
  @override
  void initState() {
    form = FormGroup({
