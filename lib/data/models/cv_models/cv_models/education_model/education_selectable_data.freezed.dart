...
EducationSelectableDataModel _$EducationSelectableDataModelFromJson(
    Map<String, dynamic> json) {
  return _EducationSelectableDataModel.fromJson(json);
}

/// @nodoc
mixin _$EducationSelectableDataModel {
  ...
  @JsonKey(ignore: true)
  $EducationSelectableDataModelCopyWith<EducationSelectableDataModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EducationSelectableDataModelCopyWith<$Res> {
  factory $EducationSelectableDataModelCopyWith(
          EducationSelectableDataModel value,
          $Res Function(EducationSelectableDataModel) then) =
      _$EducationSelectableDataModelCopyWithImpl<$Res,
...
/// @nodoc
class _$EducationSelectableDataModelCopyWithImpl<$Res,
        $Val extends EducationSelectableDataModel>
    implements $EducationSelectableDataModelCopyWith<$Res> {
  _$EducationSelectableDataModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_EducationSelectableDataModelCopyWith<$Res>
    implements $EducationSelectableDataModelCopyWith<$Res> {
  factory _$$_EducationSelectableDataModelCopyWith(
          _$_EducationSelectableDataModel value,
          $Res Function(_$_EducationSelectableDataModel) then) =
      __$$_EducationSelectableDataModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'University')
...
/// @nodoc
class __$$_EducationSelectableDataModelCopyWithImpl<$Res>
    extends _$EducationSelectableDataModelCopyWithImpl<$Res,
        _$_EducationSelectableDataModel>
    implements _$$_EducationSelectableDataModelCopyWith<$Res> {
  __$$_EducationSelectableDataModelCopyWithImpl(
      _$_EducationSelectableDataModel _value,
      $Res Function(_$_EducationSelectableDataModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_EducationSelectableDataModel(
      university: freezed == university
          ? _value._university
          : university // ignore: cast_nullable_to_non_nullable
              as List<CvDataModel>?,
...
/// @nodoc
@JsonSerializable()
class _$_EducationSelectableDataModel implements _EducationSelectableDataModel {
  _$_EducationSelectableDataModel(
      {@JsonKey(name: 'University')
  ...
  factory _$_EducationSelectableDataModel.fromJson(Map<String, dynamic> json) =>
      _$$_EducationSelectableDataModelFromJson(json);
  ...
  @override
  String toString() {
    return 'EducationSelectableDataModel(university: $university, universityDepartment: $universityDepartment, city: $city, country: $country, educationLevel: $educationLevel)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_EducationSelectableDataModel &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_EducationSelectableDataModelCopyWith<_$_EducationSelectableDataModel>
      get copyWith => __$$_EducationSelectableDataModelCopyWithImpl<
          _$_EducationSelectableDataModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_EducationSelectableDataModelToJson(
      this,
    );
  }
}

abstract class _EducationSelectableDataModel
    implements EducationSelectableDataModel {
  factory _EducationSelectableDataModel(
          {@JsonKey(name: 'University')
              final List<CvDataModel>? university,
          @JsonKey(name: 'UniversityDepartment')
              final List<CvDataModel>? universityDepartment,
  ...
  factory _EducationSelectableDataModel.fromJson(Map<String, dynamic> json) =
      _$_EducationSelectableDataModel.fromJson;
